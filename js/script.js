...
const translations = {
    fr: {
        ...
        "proj1-title": "Site Vitrine d'Entreprise",
        "proj1-desc": "Conception et réalisation d'un site web moderne et responsive pour une entreprise locale. Animations fluides et formulaires dynamiques.",
        "proj2-title": "Application Web Back-office",
        "proj2-desc": "Développement d'un tableau de bord de gestion pour la visualisation et l'analyse de données avec des fonctionnalités interactives.",
    ...
    en: {
        ...
        "proj1-title": "Corporate Showcase Site",
        "proj1-desc": "Design and realization of a modern and responsive website for a local company. Smooth animations and dynamic forms.",
        "proj2-title": "Back-office Web Application",
        "proj2-desc": "Development of a management dashboard for data visualization and analysis with interactive features.",
